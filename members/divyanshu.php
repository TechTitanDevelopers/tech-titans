...
$member = [
    ...
    'bio' => 'I’m a passionate and detail-oriented Full Stack Web Developer with a strong focus on building secure, scalable, and user-friendly web applications. Skilled in designing robust backend architectures, integrating APIs, and managing databases, while also crafting clean, responsive, and intuitive front-end interfaces.',
    'skills' => ['Backend Developer', 'System Architecture', 'Project Management', 'Full-stack Development'],
    'email' => 'divyanshu@techtitans.dev',
    'social' => [
        'linkedin' => 'https://www.linkedin.com/in/divyanshu-chaubey-5b25a531a/',
        'github' => 'https://github.com/imDivyansh18',
        'twitter' => '#'
    ]
];
?>
        ...
        <div class="profile-grid">
            <div class="profile-card">
                <div class="profile-image">
                    <img src="../images/divyanshu_photo.jpg" alt="<?php echo $member['name']; ?>">
                </div>
